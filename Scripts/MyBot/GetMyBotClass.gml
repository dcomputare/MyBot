...
if global.mybotClasses[CLASS_SCOUT]
{
    ds_list_add(classList, CLASS_SCOUT)
}
if global.mybotClasses[CLASS_PYRO]
{
    ds_list_add(classList, CLASS_PYRO)
}
if global.mybotClasses[CLASS_SOLDIER]
{
    ds_list_add(classList, CLASS_SOLDIER)
}
if global.mybotClasses[CLASS_HEAVY]
{
    ds_list_add(classList, CLASS_HEAVY)
}
if global.mybotClasses[CLASS_ENGINEER]
{
    ds_list_add(classList, CLASS_ENGINEER)
}
if global.mybotClasses[CLASS_SNIPER]
{
    ds_list_add(classList, CLASS_SNIPER)
}
if global.mybotClasses[CLASS_MEDIC]
{
...
if ds_list_empty(classList)
{
    ...
    if global.mybotNameCounter == 1 show_message("No Class Free#Choosing randomly")
    return 1
}
